# Agentic Traveler - Project Roadmap

This roadmap outlines the high-level phases for building the Agentic Traveler MVP.

## Phase 1: Foundation & Ingestion
**Goal**: Set up the project structure and enable user profile ingestion from Tally.
- **Task 01**: Project Setup (Repo, ADK, Dependencies). [DONE]
- **Task 02**: Tally Form Ingestion (Cloud Function, Firestore Schema). [DONE]
...
- **Phase 5**: Direct Booking Integrations (Skyscanner, Amadeus).
- **Phase 6**: Rich Web Frontend.
